...
const Index = () => {
    const faqs = [
        { title: "What is CDU Photoraphy?" },
        { title: "Can I use your images?" },
        { title: "May cdu photography club's images be used on Facebook and other social platforms?" },
        { title: "I found a great photo, how can I donate to that user?" },
        { title: "Does CDU Photography club offer an API?" },
